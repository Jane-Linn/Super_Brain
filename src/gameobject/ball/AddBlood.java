 ...
 * @author Wan Zhen Lin
 */
public class AddBlood extends GameObject{//ball1.png(17)
...
//色球ballNumber只能是-->1,2,6,7,8,9(色球不能是第一個)
    ...
    public AddBlood(int x, int y, int width, int height, int gameLevel, int ballNumber) {
        super(x, y, width, height);
        ballHelper = new BallHelper(width, height, ballNumber);
        isCollisioned = false;
        needPrint = true;
//        this.gameLevel = gameLevel;
        name = Global.Element.ADD_BLOOD;//在碰撞判斷時使用
